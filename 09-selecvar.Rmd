...
## Paquete **olsrr** {-}
El paquete **olsrr** [@R-olsrr] contiene varias funciones útiles para modelación, en particular se destaca la función `ols_step_all_possible` que se puede utilizar para obtener todas las regresiones posibles.
...
## Paquete **mixlm** {-}
El paquete **mixlm** [@R-mixlm] contiene un buen número de funciones para modelación. Algunas de las funciones a destacar son `forward`, `backward`, `stepWise`.
...
## Paquete **leaps** {-}
El paquete **leaps** [@R-leaps] creado por [Thomas Lumley](https://www.stat.auckland.ac.nz/people/tlum005) está basado en [Fortran](https://es.wikipedia.org/wiki/Fortran) y es útil cuando nos interese encontrar subconjuntos de covariables para optimizar las características de un modelo.
