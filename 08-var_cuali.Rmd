...
\begin{align}
Precio_i &\sim N(\mu_i, \sigma^2), \\ 
\mu_i &= \beta_0 + \beta_1 EngSiz_i + \beta_2 TComp_i + \beta_3 TSpor_i + \beta_4 TMid_i + \beta_5 TLarg_i + \beta_6 TVan_i, \\
\sigma^2 &= \text{constante}
\end{align}
...
\hat{\mu}_i &= 2.794 + 4.621 EngSiz_i + 4.644 TComp_i + 5.078 TSpor_i + \ldots \\
\hat{\sigma} &= 7.068
\end{align}
...
1. Mirar si el valor-P de cualquiera de las variables indicadoras es menor que en el nivel de significancia en el `summary(mod)`.
