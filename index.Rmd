...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'mixlm', 'MPV',
                ...
                'model', 'Matrix', 'multcomp', 'Formula', 'car'), 'packages.bib')
```
...
En el capítulo \@ref(rls) se presenta el modelo de regresión lineal simple y en el Capítulo \@ref(rlm) se generaliza el modelo básico con varias covariables. En los capítulos \@ref(ic) y \@ref(ph) se muestra como construir intervalos de confianza y como realizar pruebas de hipótesis, respectivamente.
