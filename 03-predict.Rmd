...
$$
\hat{\mu}_{y|x_0} \pm t_{\alpha / 2, n - 2} \, \sqrt{MSE \left(\frac{1}{n} + \frac{(x_0 - \bar{x})^2}{\sum(x_i - \bar{x}^2)} \right)}
$$
...
$$
\hat{y}_0 \pm t_{\alpha / 2, n - 2} \, \sqrt{MSE \left(1 +\frac{1}{n} + \frac{(x_0 - \bar{x})^2}{\sum(x_i - \bar{x}^2)} \right)}
$$
