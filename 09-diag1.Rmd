...
- `residualPlots(model)`: dibuja una gráfica de los residuos de Pearson versus cada término del predictor lineal y los valores ajustados $\hat{\mu}_i$. También entrega hace una prueba de hipótesis de curvatura para cada una de las gráficas agregando un término cuadrático y probando si se necesita el término cuadrático o no. 
