...
Estimado lector, **¿qué puede usted concluir de los resultados de este ejemplo?**

## Chequeando normalidad de los errores {.unnumbered}
...
## Chequeando si errores con media cero {.unnumbered}
...
## Chequeando si los errores tiene varianza constante {.unnumbered}
...
## Chequeando si errores no están correlacionados {.unnumbered}
...
### Ejemplo cumpliendo los supuestos {.unnumbered}
...
### Ejemplo violando los supuestos {.unnumbered}
...
En este ejemplo vamos a simular 500 observaciones del modelo mostrado abajo en el cual la varianza de $Y$ es función de $x$. Luego vamos a ajustar un modelo **incorrecto** en el cual asumimos que la varianza es constante y por último vamos a construir los gráficos de residuales para ver si se logra identificar el problema.
...
## Gráficos de residuales usando car {.unnumbered}
...
```{r}
prestige_mod2 <- lm (prestige ~ education + income + 
...
## Prueba de falta de ajuste {.unnumbered}
