...
En este capítulo se muestra como construir intervalos de confianza para un modelo de regresión lineal.
...
### Ejemplo {-}
Como ilustración vamos a usar los datos del ejemplo mostrado en el capítulo \@ref(rls). En ese ejemplo se ajustó un modelo de regresión lineal simple para explicar la Resistencia de una soldadura en función de la Edad de la misma.
...
La función `confint_sigma2` pertenece al paquete [model](https://fhernanb.github.io/model/index.html) y sirve para obtener un intervalo de confianza para el parámetro $\sigma^2$. El paquete **model** está alojado en github y para poder instalarlo se sebe usar el siguiente código.
